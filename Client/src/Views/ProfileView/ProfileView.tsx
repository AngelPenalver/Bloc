      ...
      {!loading ? (
        <div className={styles.contain}>
          <div className={styles.banner}>
            <NavLink to={"/dashboard"} className={styles.back}>
              <IconsBack />
            </NavLink>
            <Avatar
          ...
          <div className={styles.text_container}>
            ...
            <div className={styles.contain_btns}>
              <div className={styles.btn_account}>
                <NavLink to={`/change_password/${userId}`}>
                  <button className={styles.btn}>
                    Cambiar contraseña
                  </button>
                </NavLink>
                <NavLink to={`/delete/${userId}`}>
                  <button className={styles.btn}>Eliminar cuenta
                  </button>
                </NavLink>
              </div>
